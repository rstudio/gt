...
The **gt** package comes with six built-in datasets for experimenting with the API. They are called `countrypops`, `sza`, `gtcars`, `sp500`, `pizzaplace`, and `exibble`. While each of them has different subject matter, all of them allow us to quickly produce examples with reusable idioms. 
