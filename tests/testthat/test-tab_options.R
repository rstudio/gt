...
test_that("the internal `opts_df` table can be correctly modified", {
  ...
  c(opts_df_1 %>% opts_df_get("table_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_width")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("container_height"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("container_height")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("container_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("container_width")
  ) %>%
    expect_equal(c("auto", "300px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_margin_left"),
    opts_df_1 %>% opts_df_get("table_margin_right"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_margin_left"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_margin_right")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_font_size"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_font_size")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_background_color"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_background_color")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_border_top_style"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_border_top_style")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_border_top_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_border_top_width")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_border_top_color"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_border_top_color")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("heading_background_color"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("heading_background_color")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("heading_title_font_size"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("heading_title_font_size")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("heading_subtitle_font_size"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("heading_subtitle_font_size")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("heading_border_bottom_style"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("heading_border_bottom_style")
  ) %>%
    expect_equal(c("solid", "dashed"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("heading_border_bottom_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("heading_border_bottom_width")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("column_labels_font_size"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("column_labels_font_size")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("column_labels_font_weight"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("column_labels_font_weight")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("column_labels_background_color"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("column_labels_background_color")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_group_background_color"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_group_background_color")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_group_font_size"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_group_font_size")
  ) %>%
    expect_equal(c("16px", "18px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_group_font_weight"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_group_font_weight")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_group_border_top_style"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_group_border_top_style")
  ) %>%
    expect_equal(c("solid", "dashed"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_group_border_top_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_group_border_top_width")
  ) %>%
    expect_equal(c("2px", "5px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_group_border_bottom_style"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_group_border_bottom_style")
  ) %>%
    expect_equal(c("solid", "dashed"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_group_border_bottom_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_group_border_bottom_width")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_body_border_top_style"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_body_border_top_style")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_body_border_top_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_body_border_top_width")
  ) %>%
    expect_equal(c("2px", "5px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_body_border_bottom_style"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_body_border_bottom_style")
  ) %>%
    expect_equal(c("solid", "dotted"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("table_body_border_bottom_width"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("table_body_border_bottom_width")
  ) %>%
    expect_equal(c("2px", "5px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_padding"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_padding")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("summary_row_background_color"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("summary_row_background_color")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("summary_row_padding"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("summary_row_padding")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("summary_row_text_transform"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("summary_row_text_transform")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("grand_summary_row_background_color"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("grand_summary_row_background_color")
  ) %>%
    expect_equal(c(NA_character_, "pink"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("grand_summary_row_padding"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("grand_summary_row_padding")
  ) %>%
    expect_equal(c("8px", "4px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("grand_summary_row_text_transform"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("grand_summary_row_text_transform")
  ) %>%
    expect_equal(c("inherit", "lowercase"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("footnote_font_size"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("footnote_font_size")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("footnote_padding"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("footnote_padding")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("sourcenote_font_size"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("sourcenote_font_size")
  ) %>%
    expect_equal(c("90%", "12px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("sourcenote_padding"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("sourcenote_padding")
  ) %>%
    expect_equal(c("4px", "3px"))
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_striping_include_stub"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_striping_include_stub")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("row_striping_include_table_body"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("row_striping_include_table_body")
  ) %>%
  ...
  # Compare before and after values
  c(opts_df_1 %>% opts_df_get("footnote_sep"),
    attr(tbl_html, "opts_df", exact = TRUE) %>% opts_df_get("footnote_sep")
  ) %>%
    expect_equal(c("<br />", " "))
})
