test_that("rows can be added to a table in a variety of ways", {
  ...
  gt_tbl_add1_b1 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 1)
  gt_tbl_add1_b1 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_b2 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 2)
  gt_tbl_add1_b2 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_b3 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 3)
  gt_tbl_add1_b3 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_b4 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 4)
  gt_tbl_add1_b4 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_b5 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 5)
  gt_tbl_add1_b5 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_b6 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 6)
  gt_tbl_add1_b6 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_b7 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 7)
  gt_tbl_add1_b7 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_b8 <- gt_tbl_d %>% rows_add(.n_empty = 1, .before = 8)
  gt_tbl_add1_b8 %>% render_as_html() %>% expect_snapshot()
  expect_error(gt_tbl_d %>% rows_add(.n_empty = 1, .before = 9))

  gt_tbl_add1_a1 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 1)
  gt_tbl_add1_a1 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_a2 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 2)
  gt_tbl_add1_a2 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_a3 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 3)
  gt_tbl_add1_a3 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_a4 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 4)
  gt_tbl_add1_a4 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_a5 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 5)
  gt_tbl_add1_a5 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_a6 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 6)
  gt_tbl_add1_a6 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_a7 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 7)
  gt_tbl_add1_a7 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add1_a8 <- gt_tbl_d %>% rows_add(.n_empty = 1, .after = 8)
  gt_tbl_add1_a8 %>% render_as_html() %>% expect_snapshot()
  expect_error(gt_tbl_d %>% rows_add(.n_empty = 1, .after = 9))




  gt_tbl_add2_b1 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 1)
  gt_tbl_add2_b1 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_b2 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 2)
  gt_tbl_add2_b2 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_b3 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 3)
  gt_tbl_add2_b3 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_b4 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 4)
  gt_tbl_add2_b4 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_b5 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 5)
  gt_tbl_add2_b5 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_b6 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 6)
  gt_tbl_add2_b6 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_b7 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 7)
  gt_tbl_add2_b7 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_b8 <- gt_tbl_d %>% rows_add(.n_empty = 2, .before = 8)
  gt_tbl_add2_b8 %>% render_as_html() %>% expect_snapshot()
  expect_error(gt_tbl_d %>% rows_add(.n_empty = 2, .before = 9))

  gt_tbl_add2_a1 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 1)
  gt_tbl_add2_a1 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_a2 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 2)
  gt_tbl_add2_a2 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_a3 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 3)
  gt_tbl_add2_a3 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_a4 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 4)
  gt_tbl_add2_a4 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_a5 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 5)
  gt_tbl_add2_a5 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_a6 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 6)
  gt_tbl_add2_a6 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_a7 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 7)
  gt_tbl_add2_a7 %>% render_as_html() %>% expect_snapshot()
  gt_tbl_add2_a8 <- gt_tbl_d %>% rows_add(.n_empty = 2, .after = 8)
  gt_tbl_add2_a8 %>% render_as_html() %>% expect_snapshot()
