...
test_that("the `fmt_currency()` function works correctly", {
  ...
  expect_equal(
    ...
    c("\\$$1.8362$", "\\$$2.7634$", "\\$$0.9373$", "\\$$0.6430$",
      "\\$$0.2122$", "\\$$0.0000$", "\\textendash\\$$0.0232$")
  )
  ...
  expect_equal(
    (tbl_latex %>%
       ...
       render_formats_test("latex"))[["num_1"]],
    c("a \\$$1,836.23$ b", "a \\$$2,763.39$ b", "a \\$$937.29$ b",
      "a \\$$643.00$ b", "a \\$$212.23$ b", "a \\$$0.00$ b",
      "a \\textendash\\$$23.24$ b")
  )
  ...
  expect_equal(
    ...
    c("\\$$1.8362$K", "\\$$2.7634$K", "\\$$0.9373$K", "\\$$0.6430$K",
      "\\$$0.2122$K", "\\$$0.0000$K", "\\textendash\\$$0.0232$K")
  )
  ...
  expect_equal(
    ...
    c("$1.836,23$ kr.", "$2.763,39$ kr.", "$937,29$ kr.", "$643,00$ kr.",
      "$212,23$ kr.", "$0,00$ kr.", "\\textendash$23,24$ kr.")
  )
  ...
  expect_equal(
    ...
    c("kr.$1.836,23$", "kr.$2.763,39$", "kr.$937,29$", "kr.$643,00$",
      "kr.$212,23$", "kr.$0,00$", "\\textendashkr.$23,24$")
  )
  ...
  expect_equal(
    (tbl_latex %>%
       ...
       render_formats_test("latex"))[["num_1"]],
    c("EUR$1 836,23$", "EUR$2 763,39$", "EUR$937,29$", "EUR$643,00$",
      "EUR$212,23$", "EUR$0,00$", "\\textendashEUR$23,24$")
  )
