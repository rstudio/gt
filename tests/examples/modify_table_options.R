...
data <-
  ...
  tab_options(
    ...
    stub_group.border.top.width = 5,           # Top line of stub group - width
    ...
    stub_group.border.bottom.width = 4,           # Bottom line of stub group - width
