...
many_options_tbl <-
  ...
  tab_options(
    ...
    row_group.background.color = "green",     # Stub group background color
    row_group.font.size = px(14),             # Stub group labels - font size
    row_group.font.weight = "800",            # Stub group labels - font weight
    row_group.border.top.style = "solid",     # Top line of stub group - style
    row_group.border.top.width = px(5),       # Top line of stub group - width
    row_group.border.top.color = "blue",      # Top line of stub group - color
    row_group.border.bottom.style = "solid",     # Bottom line of stub group - style
    row_group.border.bottom.width = px(4),       # Bottom line of stub group - width
    row_group.border.bottom.color = "orange",    # Bottom line of stub group - color
    ...
    row.padding = px(8),                       # Padding of all data rows (stub & table body)
