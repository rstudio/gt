...
many_options_tbl <-
  ...
  tab_options(
    ...
    columns.font.size = px(16),                # Column labels - font size
    columns.font.weight = "normal",            # Column labels - font weight
    columns.background.color = "lightgray",    # Column labels background color
