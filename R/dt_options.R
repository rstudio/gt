...
dt_options_init <- function(data) {
  ...
  dplyr::tribble(
    ...
    "data_row_background_color",          TRUE,  "data_row",         "value",   NA_character_,
    ...
    "footnotes_border_style",             TRUE,  "footnotes",        "value",   "solid",
    "footnotes_border_width",             TRUE,  "footnotes",        "px",      "2px",
    "footnotes_border_color",             TRUE,  "footnotes",        "value",   "#D3D3D3",
    ...
    "source_notes_border_style",          TRUE,  "source_notes",     "value",   "solid",
    "source_notes_border_width",          TRUE,  "source_notes",     "px",      "2px",
    "source_notes_border_color",          TRUE,  "source_notes",     "value",   "#D3D3D3",
