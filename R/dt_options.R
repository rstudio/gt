...
dt_options_init <- function(data) {
  ...
  dplyr::tribble(
    ...
    "heading_border_lr_style",            TRUE,  "heading",          "value",   "hidden",
    ...
    "footnotes_border_bottom_style",      TRUE,  "footnotes",        "value",   "solid",
    ...
    "source_notes_border_bottom_style",   TRUE,  "source_notes",     "value",   "solid",
