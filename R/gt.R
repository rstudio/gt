...
#'   calls `cols_align(align = "auto")` on all columns.
#' @param auto_format Optionally have column data be formatted depending on the
#'   content contained within each column of the input `data`. Internally, this
#'   calls [fmt_auto()] on all columns.
