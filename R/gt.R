...
#' @param i_html Should the table be an interactive table when rendered as HTML?
...
gt <- function(
  ...
  # Apply the `gt_tbl` class (and possibly the `gti_tbl` class) to the
  # object while also keeping the `data.frame` class
  class(data) <- c(if (i_html) "gti_tbl", "gt_tbl", class(data))
