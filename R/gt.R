...
#' @param table_id the table ID. By default, this will be a random ID as
#'   generated by the \code{random_id()} function. If set to \code{NULL} then no
#'   table ID will be applied.
