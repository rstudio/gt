...
#' output filename, producing either an HTML, LaTeX, RTF, PNG, JPG, or PDF file.
#'
...
#'
#' We can create image files based on the HTML version of the \pkg{gt} table.
#' With the filename extensions \code{.png} and \code{.jpg}, we get PNG and JPEG
#' image files. A PDF document can be generated by using the \code{.pdf}
#' extension.
#'
