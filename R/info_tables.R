...
#' @description
#'
#' [fmt_date()] lets us format date-based values in a convenient
#' manner using preset styles. The table generated by `info_date_style()`
#' provides a quick reference to all styles, with associated format
...
#' colors), from `paletteer::paletteer_d()`. Once we are
