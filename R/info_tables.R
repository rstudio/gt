...
#'
#' The \code{fmt_date()} function lets us format date-based values in a
#' convenient manner using preset styles. The table generated by the
#' \code{info_date_style()} function provides a quick reference to all 14
#' styles, with associated number codes, the format names, and example outputs
#' using a fixed date (\code{2000-02-29}).
#' @examples
...
#'
#' The \code{fmt_time()} function lets us format time-based values in a
#' convenient manner using preset styles. The table generated by the
#' \code{info_time_style()} function provides a quick reference to all five
#' styles, with associated number codes, the format names, and example outputs
#' using a fixed time (\code{14:35}).
#' @examples
#' # Get a table of info on the different
...
#'
#' The \code{fmt_currency()} function lets us format numeric values as
#' currencies. The table generated by the \code{info_currencies()} function
...
#' \code{49.95}) to demonstrate the default formatting of each currency.
#'
...
#' \code{info_locales()} function provides a quick reference to all the
...
#' \code{11027}) to demonstrate the default formatting of each locale.
#'
...
#' letter corresponding to the base locale ID to \code{begins_with}. This will
