...
#'
#' This function applies a set of styles related to background colors,
...
#'     subtitle = "The table's subtitle"
#'   ) %>%
#'   opt_stylize(style = 6, color = "aqua")
#' ```
#'
#' \if{html}{\out{
...
opt_stylize <- function(
  ...
  if (!(length(color) == 1 && color %in% names(preset_colors))) {
    cli::cli_abort(c(
      ...
      "*" = "\"blue\", \"orange\", \"aqua\", \"pink\", \"green\", \"red\", or \"gray\""
    ))
  }
