...
#' }}
#'
#' When working with values bounded between -1 and 1 (such as correlations or
#' proportions), you might want to drop the leading zero to save space and follow
#' conventions used in certain fields. Use `drop_leading_zero = TRUE` to do this.
#'
#' ```r
#' dplyr::tibble(
