...
# create_body_component_r_old <- function(data) {
#
...
# create_source_notes_component_r_old <- function(data) {
#
...
# create_footnotes_component_r_old <- function(data) {
#
#   body <- dt_body_get(data = data)
...
# col_width_twips_old <- function() {
#   935L
# }

# rtf_head_old <- function() {
#
#   paste0(
...
# rtf_title_subtitle_old <- function(title, subtitle, n_cols) {
#
...
# rtf_title_old <- function(title, n_cols) {
#
#   twips <- 1:n_cols * col_width_twips()
#
#   paste0(
...
# rtf_heading_group_row_old <- function(spanners_lengths,
#                                   headings,
#                                   spanners) {
#
...
# rtf_heading_row_old <- function(content) {
#
...
# rtf_body_row_old <- function(content,
#                          type) {
#
#   twips <- 1:length(content) * col_width_twips()
#
...
# rtf_last_body_row_old <- function(content) {
#
#   twips <- 1:length(content) * col_width_twips()
#
#   output <-
...
# create_columns_component_r_old <- function(data) {
#
#   boxh <- dt_boxhead_get(data = data)
