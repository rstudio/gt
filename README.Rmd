...
The **gt** API is designed to be both straightforward yet powerful. The emphasis is on simple functions for the everyday display table needs. Here is a brief example of how to use the **gt** to create an HTML **gt Table** table with the included `sp500` dataset:
...
Should you need more customizability, there are many functions available in the **gt** to make that possible.
...
You can install the development version of **gt** from **GitHub** using the **remotes** package. Use the following in the R console to install the **devtools** package (which in turns installs **remotes**) and to install **gt**.
