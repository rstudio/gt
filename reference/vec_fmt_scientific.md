...
targeted values are rendered in scientific notation, where extremely
...
Using `vec_fmt_scientific()` with the default options will create a
character vector with values in scientific notation. Any `NA` values
